...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(975, 634)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.stackedWidget = QtWidgets.QStackedWidget(self.centralwidget)
        self.stackedWidget.setGeometry(QtCore.QRect(160, 0, 811, 611))
        ...
        self.OCRButtons.setGeometry(QtCore.QRect(570, 50, 185, 421))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(50, 20, 85, 381))
        ...
        self.retrieveOCRDataButton = QtWidgets.QPushButton(self.layoutWidget1)
        self.retrieveOCRDataButton.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.retrieveOCRDataButton.setObjectName("retrieveOCRDataButton")
        self.verticalLayout.addWidget(self.retrieveOCRDataButton)
        self.importVideoBar_2 = QtWidgets.QWidget(self.OCRPage)
        self.importVideoBar_2.setGeometry(QtCore.QRect(30, 240, 431, 111))
        self.importVideoBar_2.setStyleSheet("background-color: rgb(230, 230, 230);")
        self.importVideoBar_2.setObjectName("importVideoBar_2")
        self.layoutWidget_2 = QtWidgets.QWidget(self.importVideoBar_2)
        self.layoutWidget_2.setGeometry(QtCore.QRect(30, 20, 381, 69))
        ...
        self.textEdit_3.setStyleSheet("alternate-background-color: rgb(255, 255, 255);\n"
"background-color: rgb(255, 255, 255);")
        ...
        self.browse_file_btn_2 = QtWidgets.QPushButton(self.layoutWidget_2)
        ...
        self.layoutWidget2 = QtWidgets.QWidget(self.alphaposeButtons)
        self.layoutWidget2.setGeometry(QtCore.QRect(50, 20, 85, 371))
        ...
        self.performPoseTrackingButton_2 = QtWidgets.QPushButton(self.layoutWidget2)
        self.performPoseTrackingButton_2.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.performPoseTrackingButton_2.setObjectName("performPoseTrackingButton_2")
        self.verticalLayout_4.addWidget(self.performPoseTrackingButton_2)
        self.label_8 = QtWidgets.QLabel(self.layoutWidget2)
        self.label_8.setScaledContents(False)
        self.label_8.setWordWrap(True)
        self.label_8.setObjectName("label_8")
        self.verticalLayout_4.addWidget(self.label_8)
        self.retrievePoseTrackingDataButton_2 = QtWidgets.QPushButton(self.layoutWidget2)
        ...
        self.layoutWidget3 = QtWidgets.QWidget(self.importVideoBar)
        self.layoutWidget3.setGeometry(QtCore.QRect(20, 20, 391, 69))
        ...
        self.textEdit_2.setStyleSheet("alternate-background-color: rgb(255, 255, 255);\n"
"background-color: rgb(255, 255, 255);")
        ...
        self.browse_file_btn_3 = QtWidgets.QPushButton(self.layoutWidget3)
        ...
        self.sidebar.setGeometry(QtCore.QRect(0, 0, 161, 601))
        self.sidebar.setObjectName("sidebar")
        self.layoutWidget4 = QtWidgets.QWidget(self.sidebar)
        self.layoutWidget4.setGeometry(QtCore.QRect(20, 50, 121, 221))
        self.layoutWidget4.setObjectName("layoutWidget4")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.layoutWidget4)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.mask_btn = QtWidgets.QPushButton(self.layoutWidget4)
        ...
        self.ocr_btn = QtWidgets.QPushButton(self.layoutWidget4)
        ...
        self.alphapose_btn = QtWidgets.QPushButton(self.layoutWidget4)
        ...
        self.analysis_btn = QtWidgets.QPushButton(self.layoutWidget4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "OCR"))
        self.performOCRButton.setText(_translate("MainWindow", "Perform OCR"))
        self.label_4.setText(_translate("MainWindow", "OCR output detected retrieve data now"))
        self.retrieveOCRDataButton.setText(_translate("MainWindow", "Retrieve data"))
        ...
        self.performPoseTrackingButton_2.setText(_translate("MainWindow", "Pose tracking"))
